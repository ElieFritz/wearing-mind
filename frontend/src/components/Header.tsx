  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        <button className="p-2 hover:bg-[#F8F8FA] rounded-full transition-colors text-[#1E2A5A]">
      ...
      <div className="flex items-center gap-4">
        ...
        <Link href="/cart" className="p-2 relative block hover:bg-[#F8F8FA] rounded-full transition-colors text-[#1E2A5A]">
